...
const TOLERANCE_DAYS: Partial<Record<ScheduleType, number>> = {
  weekly: 2,
  monthly: 7,
  quarterly: 21,
  semiannual: 30,
...
export function toleranceDays(scheduleType: ScheduleType | null, intervalDays?: number | null): number {
  ...
  return (scheduleType && TOLERANCE_DAYS[scheduleType]) ?? 7
}
