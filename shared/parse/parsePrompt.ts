...
TASK RULES (be EXHAUSTIVE — emit a separate task for EVERY distinct recurring upkeep procedure the manual describes, plus every genuine setup step. A typical consumer appliance yields ~6-15; do not stop at the obvious one or two.):
...
- priority_tier: essential=safety hazard or voids warranty, recommended=extends lifespan, optional=cosmetic
