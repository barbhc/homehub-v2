...
| lib (dashboard) | **getDashboardStats + getAllMaintenanceTasks + getDashboardTasks = ported** (denorm reads; power /maintenance + the Home feed w/ Fix A cap); getUpcomingTasks/getExpiringWarranties/getHomeNotices/getInsights = ported (denorm/items reads — verified 2026-07-14) | mixed |
